...
namespace Onemt.ResourceManagement.ResourceProviders
{
    public interface IAssetBundleResource
    {
        ...
        AssetBundleRequest GetAssetPreloadRequest();
    }
    ...
    internal class AssetBundleResource : IAssetBundleResource//, IUpdateReceiver
    {
        ...
        private void LoadAssetbundle()
        {
            ...
            //UnityEngine.Debug.LogErrorFormat("[AssetBundleProvider.BeginOperation]   Path : {0}.", path);
            m_RequestOperation = AssetBundle.LoadFromFileAsync(path, 0, ConstDefine.kAssetbundleOffset);
            AddCallbackInvokeIfDone(m_RequestOperation, RequestCompleted);
        }
    ...
    public class AssetBundleProvider : ResourceProviderBase
    {
        ...
        public override void Release(IResourceLocation location, object asset)
        {
            ...
            if (asset is AssetBundleResource assetBundleResource)
            {
