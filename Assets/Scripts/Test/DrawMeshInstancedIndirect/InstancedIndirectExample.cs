...
{ 
    ...
    void Start() {
        //ComputeBufferType.IndirectArguments被用作Graphics.DrawMeshInstancedIndirect中
    ...
    void UpdateBuffers() {
        ...
        if (instanceMesh != null)
            //instanceMesh.subMeshCount是mesh中子网格的数量
            subMeshIndex = Mathf.Clamp(subMeshIndex, 0, instanceMesh.subMeshCount - 1);

        // Positions
        if (positionBuffer != null)
            positionBuffer.Release();
        //positionBuffer中记录的Vector4，包含4个float所以是16
